...
export const DashboardMap = ({ isLoading = false, className = '' }: DashboardMapProps) => {
  ...
  return (
    <div className={`relative h-full w-full bg-gray-100 dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm ${className}`}>
      {!mapInitialized ? (
          ...
          <div className="absolute top-4 left-4 z-10 bg-white dark:bg-gray-800 rounded-md shadow-md p-2">
            <div className="flex space-x-2">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-xs text-gray-700 dark:text-gray-300">In Use</span>
              </div>
              <div className="flex items-center space-x-1">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-xs text-gray-700 dark:text-gray-300">Fault</span>
              </div>
            </div>
          </div>
