...
import { 
  ...
  TrendingUp, TrendingDown, Plus, Eye, Search
} from 'lucide-react';
...
const DashboardPage: React.FC = () => {
  ...
  return (
    <PageLayout title="Dashboard" description="EV Charging Network Overview" noCard>
      <Helmet>
        ...
        <UnfoldCard title="Environmental Impact" className="lg:col-span-2" description="Positive effects of EV charging">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Cars Removed Equivalent</p>
            </div>
